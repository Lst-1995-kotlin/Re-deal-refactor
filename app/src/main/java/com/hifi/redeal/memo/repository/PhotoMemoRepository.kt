...
class PhotoMemoRepository @Inject constructor(
    ...
    fun addPhotoMemo(clientIdx:Long, photoMemoContext:String, uriList:MutableList<Uri>, callback:(Task<Void>) -> Unit){
        ...
        photoMemoRef
            ...
            .get().addOnSuccessListener{querySnapshot ->
                ...
                for(i in 0 until uriList.size){
                    val fileName = "image_user${currentUser.userIdx}_client${clientIdx}_photoMemo${photoMemoIdx}_$i"
